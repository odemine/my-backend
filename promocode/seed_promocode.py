...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        promocode_data = [
            ...
            {"name": "New Customer", "code" : "NEW50", "discount_percentage": 50, "condition": "New Customer Only", "description" : "Welcome! Get 50% off for your first rental as a token of appreciation."},
